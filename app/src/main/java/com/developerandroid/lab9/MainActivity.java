package com.developerandroid.lab9;
       ...
       /* // Handle action bar item clicks here. The action bar will
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_default:
                if (item.isChecked()) item.setChecked(false); else
                    item.setChecked(true); mainLayout.setBackgroundColor(Color.WHITE);
                return true;

            case R.id.menu_settings:
                Toast.makeText(this, "Menu seleccionado: Configuracion", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(this, Configuracion.class);
                startActivity(intent);

                return true;
            case R.id.menu_about:
                Toast.makeText(this, "Menu seleccionado: Acerca de",
